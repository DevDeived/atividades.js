...
// let array = [13, 5, 23, 30, 32, 15];

// function encontrarElemento(array, elementos) {
//     for (let index = 0; index < array.length; index++) {
//         if(array[index] === elementos) {
//             return true
//         }        
//     }
//     return false
...
// console.log(encontrarElemento(array, 15))
...
// const arrays = [12, 15, 18, 21, 24, 27];

// function filtrarPares(arrays) {
...
// function habilitadoOuNao(idade) {
//     if(idade >=18) {
